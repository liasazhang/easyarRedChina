package cn.easyar.samples.helloar.bean;
...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.climb_mo, "爬雪山", 1));
        list.add(new DataBean(R.drawable.ludingqiao, "飞夺泸定桥", 3));
        list.add(new DataBean(R.drawable.wuqi, "吴起镇会师", 3));
        list.add(new DataBean(R.drawable.siduchishui, "四渡赤水", 1));
...
//        list.add(new DataBean("http://vfx.mtime.cn/Video/2019/03/09/mp4/190309153658147087.mp4", "第一个放视频", 2));
        list.add(new DataBean(R.drawable.banner1, "听风.赏雨", 1));
        list.add(new DataBean(R.drawable.banner2, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.banner3, "爱美.人间有之", 1));
        list.add(new DataBean(R.drawable.banner4, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.banner5, "洋洋洋.气质篇", 1));
        return list;
    }
